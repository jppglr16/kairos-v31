...
SYMBOLS={
    ...
    # MCX
        'CRUDEOIL': {'token':'486503','exchange':'MCX'},  # CRUDEOIL20APR26FUT
        'GOLDM': {'token':'477904','exchange':'MCX'},  # GOLDM03APR26FUT
        'SILVERM': {'token':'466029','exchange':'MCX'},  # SILVERMIC30APR26FUT
        'NATURALGAS': {'token':'487465','exchange':'MCX'},  # NATURALGAS27APR26FUT
    # NSE Stocks
