...
SYMBOLS={
    ...
    'SILVERM': {'token':'466029','exchange':'MCX'}  # SILVERMIC30APR26FUT,  # SILVERMIC30APR26FUT
    'NATURALGAS': {'token':'475111','exchange':'MCX'}  # NATURALGAS26MAR26FUT,  # NATURALGAS26MAR26FUT
    # NSE Stocks
